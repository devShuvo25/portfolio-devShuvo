    ...
    >
      <div className="max-w-6xl mx-auto px-6 text-center">
        ...
        <p className="mb-10 text-gray-300">
          A blend of coding, design, and urban planning skills that power my projects and professional journey.
        </p>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
          {skills.map((skill, index) => (
            <motion.div
              ...
              className="bg-[#1F262E] rounded-3xl p-6 shadow-md hover:shadow-xl transition-shadow hover:scale-105 cursor-pointer"
            >
